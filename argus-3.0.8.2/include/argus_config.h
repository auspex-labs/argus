...
/* Using System TcpWrappers Library */
/* #undef ARGUS_WRAPPERS */
...
/* Define to 1 if you have the declaration of `fromhost ', and to 0 if you
   don't. */
/* #undef HAVE_DECL_FROMHOST_ */
...
/* Define to 1 if you have the `pcap_next_ex' function. */
...
#define PACKAGE_NAME "Argus Server Programs"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Argus Server Programs 3.0.8"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "argus"
